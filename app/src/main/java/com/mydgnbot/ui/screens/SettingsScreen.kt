        ...
        Column(
            ...
            Row(
                ...
                RadioButton(
                    ...
                    onClick = { playerType = "1" }
                )
                Text("Safe")

                // playerType == "2" => Quicksell
                RadioButton(
                    selected = playerType == "2",
                    onClick = { playerType = "2" }
                )
                Text("Quick Sell")
            }
            ...
            OutlinedTextField(
                ...
                label = { Text("Search Interval (seconds)") },
                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                singleLine = true,
                modifier = Modifier.fillMaxWidth()
            )
